...
export class ExifReader {
    ...
    private readThumbnailImage(dataView, tiffStart, firstIFDOffset, bigEnd) {
        // get the IFD1 offset
        var IFD1OffsetPointer = this.getNextIFDOffset(dataView, tiffStart + firstIFDOffset, bigEnd);
        ...
        var thumbTags = this.readTags(dataView, tiffStart, tiffStart + IFD1OffsetPointer, this.IFD1Tags, bigEnd);
    ...
    private getTag(img, tag) {
        if (!this.imageHasData(img)) return;
        return img.exifdata[tag];
    }

    private getIptcTag(img, tag) {
        if (!this.imageHasData(img)) return;
        return img.iptcdata[tag];
    }

    private getAllTags(img) {
        if (!this.imageHasData(img)) return {};
        var a,
            data = img.exifdata,
            tags = {};
...
export class ExifTag {
    static GPSVersionID = 'GPSVersionID';
    static GPSLatitudeRef = 'GPSLatitudeRef';
    static GPSLatitude = 'GPSLatitude';
    static GPSLongitudeRef = 'GPSLongitudeRef';
    static GPSLongitude = 'GPSLongitude';
    static GPSAltitudeRef = 'GPSAltitudeRef';
    static GPSAltitude = 'GPSAltitude';
    static GPSTimeStamp = 'GPSTimeStamp';
    static GPSSatellites = 'GPSSatellites';
    static GPSStatus = 'GPSStatus';
    static GPSMeasureMode = 'GPSMeasureMode';
    static GPSDOP = 'GPSDOP';
    static GPSSpeedRef = 'GPSSpeedRef';
    static GPSSpeed = 'GPSSpeed';
    static GPSTrackRef = 'GPSTrackRef';
    static GPSTrack = 'GPSTrack';
    static GPSImgDirectionRef = 'GPSImgDirectionRef';
    static GPSImgDirection = 'GPSImgDirection';
    static GPSMapDatum = 'GPSMapDatum';
    static GPSDestLatitudeRef = 'GPSDestLatitudeRef';
    static GPSDestLatitude = 'GPSDestLatitude';
    static GPSDestLongitudeRef = 'GPSDestLongitudeRef';
    static GPSDestLongitude = 'GPSDestLongitude';
    static GPSDestBearingRef = 'GPSDestBearingRef';
    static GPSDestBearing = 'GPSDestBearing';
    static GPSDestDistanceRef = 'GPSDestDistanceRef';
    static GPSDestDistance = 'GPSDestDistance';
    static GPSProcessingMethod = 'GPSProcessingMethod';
    static GPSAreaInformation = 'GPSAreaInformation';
    static GPSDateStamp = 'GPSDateStamp';
    static GPSDifferential = 'GPSDifferential';

    static DateTimeOriginal = 'DateTimeOriginal';
}
